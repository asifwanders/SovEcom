...
Press **⌘K** (Mac) or **Ctrl+K** (Windows/Linux), or click the search bar at the top, to open global search. Start typing to find products, orders (by number), and customers (by email) at once; use the arrow keys and Enter to jump straight to a result. You only see the result types your role can read.
