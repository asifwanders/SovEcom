...
/**
 * Unit tests for the notify-back-in-stock module — pure handler/runner/settings logic against a
 * MOCKED SDK. No DB, no worker, no network. The real-runtime + real-Postgres path is covered by the
 * API integration suite (apps/api/test/integration/modules/notify-back-in-stock.int-spec.ts).
 *
